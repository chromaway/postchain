...
import net.postchain.gtx.merkle.GtxMerkleBasics.HASH_PREFIX_NODE_GTX_OPERATION
import net.postchain.gtx.merkle.GtxMerkleBasics.HASH_PREFIX_NODE_GTX_TRANSACTION_BODY
import net.postchain.gtx.merkle.GtxMerkleBasics.HASH_PREFIX_NODE_GTX_TRANSACTION
...
/**
 * Represents the top a sub tree generated by a [OperationGTXValue]
 *
 * @param size is how many arguments we have + 1 (since we are adding the operation name).
 */
class GtxOperationHeadNode(left: BinaryTreeElement, right: BinaryTreeElement, isProofLeaf: Boolean, content: GTXValue, val size: Int):
        SubTreeRootNode<GTXValue>(left, right, isProofLeaf, content){

    override fun getPrefixByte(): Byte = HASH_PREFIX_NODE_GTX_OPERATION
}


/**
 * Represents the top a sub tree generated by a [TransactionBodyGTXValue]
 *
 * @param size is how many operations we have.
 */
class GtxTransBodyHeadNode(left: BinaryTreeElement, right: BinaryTreeElement, isProofLeaf: Boolean, content: GTXValue, val size: Int):
        SubTreeRootNode<GTXValue>(left, right, isProofLeaf, content){

    override fun getPrefixByte(): Byte = HASH_PREFIX_NODE_GTX_TRANSACTION_BODY
}

/**
 * Represents the top a sub tree generated by a [TransactionGTXValue]
 *
 * @param size is how many signatures we have.
 */
class GtxTransHeadNode(left: BinaryTreeElement, right: BinaryTreeElement, isProofLeaf: Boolean, content: GTXValue, val size: Int):
        SubTreeRootNode<GTXValue>(left, right, isProofLeaf, content){

    override fun getPrefixByte(): Byte = HASH_PREFIX_NODE_GTX_TRANSACTION
}
