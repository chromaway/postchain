...
/**
 * H2 database sql commands
 */
object H2SQLCommands : SQLCommands {
    override val createTableBlocks: String = "CREATE TABLE blocks" +
            " (block_iid BIGINT PRIMARY KEY," +
    ...
    override val createTableMeta : String = "CREATE TABLE meta (key VARCHAR(500) PRIMARY KEY, value TEXT)"

    override val insertBlocks: String = "INSERT INTO blocks (chain_id, block_height) VALUES (?, ?)"

    override val insertTransactions : String = "INSERT INTO transactions (chain_id, tx_rid, tx_data, tx_hash, block_iid) VALUES (?, ?, ?, ?, ?)"
